...
const App = () => {
  ...
  const getAllRequest = async() => {
    ...
    //     return req
      ...
      let res = await axios.get('http://localhost:3001/requests/', {
      headers: {
         Authorization: `Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE2M…I6M30.t4AV2_r2qPon3daCOF_JlHWZMEiYbOuRNdG0hkT92FY`
       }
    }).then(response => {
