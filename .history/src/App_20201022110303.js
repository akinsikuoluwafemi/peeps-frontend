...
const App = () => {
  ...
  const [allUserIdContext, setAllUserIdContext] = useState([]);
  ...
  const getCurrentUser = async () => {
    let res = await axios
      ...
      .then((response) => {
        ...
        const getAllI response.data.map(user => user.id)
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        <AllUserIdContext.Provider value={{allUserIdContext, setAllUserIdContext}}>
                                          <Navbar />
