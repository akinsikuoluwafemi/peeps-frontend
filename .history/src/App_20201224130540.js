...
const App = ({cableApp}) => {
  ...
  const getAllRequest = async () => {
    let res = await axios
      .get("https://peeps-platform.herokuapp.com/requests/", {
        headers: {
  ...
  const getCurrentUser = async () => {
    let res = await axios
      .get("https://peeps-platform.herokuapp.com/users", {
        headers: {
          Authorization: `Basic ${userData.token}`,
        },
      })
  ...
  const getAllRooms = async () => {
    ...
    let res = await axios
      .get(`https://peeps-platform.herokuapp.com/rooms/`, {
        headers: {
  ...
  return (
    <>
      <RequestFormContext.Provider value={{showRequestForm, setShowRequestForm}}>
