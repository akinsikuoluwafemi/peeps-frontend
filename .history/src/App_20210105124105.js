...
const App = ({cableApp}) => {
  ...
  const [roomToRepublish, setRoomToRepublish] = useState([])
    ...
    let res = await axios
      ...
      .then(
        (result) => {
          ...
          setRoomToRepublish(result.data);
                                                        ...
                                                        >
                                                          ...
                                                          >
                                                            ...
                                                            >
                                                              ...
                                                              >
                                                                <RoomToRepublishContext.Provider value={{roomToRepublish, setRoomToRepublish}}>
                                                                  <Navbar />
                                                                ...
                                                                </RoomToRepublishContext.Provider>
                                                              </DeactivateContext.Provider>
                                                            </CurrentVolunteerContext.Provider>
                                                          </SelectedRequestContext.Provider>
                                                        </HelperTextContext.Provider>
