...
import { SelectedReqDescContext, SelectedRoomContext, AllRequestContext, UserContext, ReqOwnerFirstNameContext } from "../../ContextFile";
...
export default function RoomItem({ room, onRoomSelect, SelectedChatContext }) {
  ...
  return (
    <>
      <div style={{pointer-events:none}} onClick={getRoomDetails} class="friend-drawer friend-drawer--onhover">
        <div class="text">
