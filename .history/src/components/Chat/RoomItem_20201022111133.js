...
import { SelectedReqDescContext, SelectedRoomContext, AllRequestContext, UserContext, ReqOwnerFirstNameContext, AllUserIdContext } from "../../ContextFile";
...
export default function RoomItem({ room, onRoomSelect, SelectedChatContext }) {
  ...
  let { } = useContext(AllUserIdContext);
