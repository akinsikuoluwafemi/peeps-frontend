...
let {allRooms} = useContext(AllRoomContext)    
  ...
  let {} requiresRepublishing, setRequiresRepublishing ] = useState(RepublishingContext)
  ...
  const handleClose = () => {
    ...
    return (
      <RepublishingContext.Provider value={{requiresRepublishing, setRequiresRepublishing}}>
        <div>
          <Button
            variant="contained"
            color="primary"
          ...
          >
            ...
            <DialogContent>
              <DialogContentText id="alert-dialog-slide-description">
                <RoomList requiresRepublishing={requiresRepublishing} allRooms={allRooms} />
                <RepublishRoom />
              </DialogContentText>
            </DialogContent>
            {/* <DialogActions>
