...
import { NavLink, useHist } from 'react-router-dom';
    ...
    <div class="container">
      <div class=" navbar navbar-expand-lg ">
        ...
        <div id="contentOfNavbar" class="collapse navbar-collapse">
          ...
          <NavLink style={{padding: '6px 12px', background: 'green', color: 'white', borderRadius: '3px'}} class=" btn  text-white border" to="/signup">
              Join for free
          </NavLink>
        </div>
      </div>
