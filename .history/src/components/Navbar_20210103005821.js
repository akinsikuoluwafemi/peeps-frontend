...
import
  {
    AllRequestContext, UserContext, FirstNameContext, RequestFormContext,
    ...
    <div className=" ">
      <div className="bg-dark">
        <div className="navbar navbar-expand-lg navbar-dark ">
          <NavLink onClick={() => window.location.reload()} className="navbar-brand" to="/feed">
            Peeps
          </NavLink>
          <button
            style={{border: 'none'}}
          ...
          <div id="contentOfNavbar" class="collapse navbar-collapse">
            ...
            {userData.isLoggedIn ? (
              <>
                ...
                <Button
                  onClick={() => setShowRequestForm((prevValue) => !prevValue)}
                  style={{ margin: ".5rem" }}
                  variant="contained"
                  color="primary"
