...
export default function RoomItem({ room }) {
  ...
  console.log(currentRoom.room.sender_id);
  ...
  const getVolunteer = () =>{
    if (selectedRequest) {
      ...
      const volunteer =  allVolunteers.filter(item => item.user_id === currentRoom.room.sender_id && item.request_id === selectedRequest.id  )

      console.log(colunteer)
