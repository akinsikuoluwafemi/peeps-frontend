...
export const Map = () =>
{
  ...
  let [clickedTwice, setClickedTwice] = useState(JSON.parse(localStorage.getItem("clickedbefore")) || null);
  ...
  const onVolunteerClick = async () => {
    ...
    setClickedTwice(localStorage.setItem("clickedbefore", JSON.stringify(true)));
