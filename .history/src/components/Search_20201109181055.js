...
export const Map = () =>
{
  ...
  const onVolunteerClick = async () => {
    ...
    const checkAvailability = (arr, obj) => {
      return arr.fi((arrVal) => {
        return obj === arrVal;
      })
    }

    console.log(checkAvailability(allVolunteers, data))
    

    // const alreadyVolunteered = allVolunteers.some(data)
    // console.log(alreadyVolunteered)

    setNumClick(prevVal => prevVal + 1)
    alert('you clicked' + numClick + 'times')
