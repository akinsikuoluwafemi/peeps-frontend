...
export const Map = () =>
{
  ...
  const getResponders = () => {
    let v = allVolunteers.filter( responder => {
      return responder.user_id === userId && responder.request_id === requestId
    })
    console.log('-------')
    console.log('-------')
  ...
  //       </button>
  //     );
  //   } else if (addOneToCount > 0 && userId === 3) {
  //     return <p className="badge h3 badge-info">You have volunteered for this before</p>;
