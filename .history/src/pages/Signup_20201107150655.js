...
const Signup =() =>  {
  ...
  const handleFile = (event) => {
    ...
    Array.from(inputRef.files).forEach(file => uploadFile(file))
    inputRefcurrent.value=null
  ...
  const uploadFile = (file) => {
     const url =  "http://localhost:3001/rails/active_storage/direct_uploads"
  ...
  const handleSubmit = async (e) => {
    ...
    //   formUserImage.append('avatar', selectedImage);
    // }
